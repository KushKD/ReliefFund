...
public class ReliefFundSmsVerifyCatcher {
    private final static int PERMISSION_REQUEST_CODE = 12;

    private Activity activity;
    private Fragment fragment;
    private ReliefFundOnSmsCatchListener<String> onSmsCatchListener;
    private ReliefFundSmsReceiver smsReceiver;
    private String phoneNumber;
    private String filter;

    public ReliefFundSmsVerifyCatcher(Activity activity, ReliefFundOnSmsCatchListener<String> onSmsCatchListener) {
        this.activity = activity;
        this.onSmsCatchListener = onSmsCatchListener;
        smsReceiver = new ReliefFundSmsReceiver();
        smsReceiver.setCallback(this.onSmsCatchListener);
    }

    public ReliefFundSmsVerifyCatcher(Activity activity, Fragment fragment, ReliefFundOnSmsCatchListener<String> onSmsCatchListener) {
