package cmreliefdund.kushkumardhawan.com.ruleview;
...
public class MoneySelectRuleView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        maxValue = ta.getInt(R.styleable.MoneySelectRuleView_msrv_maxValue, 50_000_000);
        ...
        valueUnit = ta.getInt(R.styleable.MoneySelectRuleView_msrv_valueUnit, 1); //earlier 100
